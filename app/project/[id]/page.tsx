...
import ProjectActionsComponent from "@/components/project-actions.component";
import RelatedProjectsComponent from "@/components/related-projects.component";
      ...
      <section className="flexBetween gap-y-8 max-w-4xl max-xs:flex-col w-full">
        ...
        {session?.user?.email === projectDetails?.createdBy?.email && (
          <div className="flex justify-end items-center gap-2">
            <ProjectActionsComponent projectId={projectDetails?.id} />
          </div>
        )}
      </section>
